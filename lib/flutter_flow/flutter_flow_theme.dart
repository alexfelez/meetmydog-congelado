...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF5DAA8E);
  late Color tertiary = const Color(0xFFD1B79C);
  late Color alternate = const Color(0xFFE6B64A);
  ...
  late Color accent2 = const Color(0xFFA9D4A8);
  late Color accent3 = const Color(0xFFF2A900);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF8C00);
  late Color secondary = const Color(0xFF3B7A6A);
  late Color tertiary = const Color(0xFFBFAF8D);
  late Color alternate = const Color(0xFFD6A54D);
  ...
  late Color accent1 = const Color(0xFFFF4F3D);
  late Color accent2 = const Color(0xFF80C9A1);
  late Color accent3 = const Color(0xFFE1A300);
