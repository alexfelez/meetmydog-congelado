...
class MenuSettingsWidget extends StatefulWidget {
  ...
  static String routeName = 'Menu_Settings';
  static String routePath = '/menuSettings';
                        ...
                        var confirmDialogResponse = await showDialog<bool>(
                              ...
                              builder: (alertDialogContext) {
                                return AlertDialog(
                                  title: Text('AVISO'),
                                  content: Text(
                                      'Vas a eliminar tu cuenta de la aplicación. Esto eliminará tus datos, los de tus perros y toda la información asociada. ¿Estás seguro?'),
                                  actions: [
                                    TextButton(
                        ...
                        if (confirmDialogResponse) {
                          ...
                          confirmDialogResponse = await showDialog<bool>(
                                ...
                                builder: (alertDialogContext) {
                                  return AlertDialog(
                                    ...
                                    content: Text(
                                        'Confirma de nuevo para evitar borrados accidentales'),
                                    actions: [
                                      TextButton(
                                        onPressed: () => Navigator.pop(
                                            alertDialogContext, false),
                                      ...
                                      TextButton(
                                        onPressed: () => Navigator.pop(
                                            alertDialogContext, true),
                                        child: Text('Si, elimina mi cuenta'),
                                      ),
                                    ],
                                  );
                                },
                          ...
                          if (confirmDialogResponse) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text(
                                  'Tu cuenta se ha eliminado con éxito. Te echaremos de menos!',
                                  style: TextStyle(
