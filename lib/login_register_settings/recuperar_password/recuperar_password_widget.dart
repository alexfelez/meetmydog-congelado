...
class RecuperarPasswordWidget extends StatefulWidget {
  ...
  static String routeName = 'Recuperar_Password';
                  ...
                  onPressed: () async {
                    ...
                    await showDialog(
                      ...
                      builder: (alertDialogContext) {
                        return AlertDialog(
                          title: Text('Se ha enviado un enlace a tu email'),
                          content: Text(
                              'Pulsa el enlace para restablecer la contraseña'),
                          actions: [
                            TextButton(
                              onPressed: () =>
